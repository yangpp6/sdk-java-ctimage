 ...
 * Entity: CreateEcsDataDiskImageRequestBody
 */
public class CreateEcsDataDiskImageRequestBody {
    /**
     * dataDiskID
     * 指定的云主机的数据盘 ID。可使用<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=8290&data=87" target="_blank">查询云主机的云硬盘列表</a>接口来查询您的云主机的云硬盘
     */
    ...
    /**
     * set dataDiskID
     * @param dataDiskID 指定的云主机的数据盘 ID。可使用<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=8290&data=87" target="_blank">查询云主机的云硬盘列表</a>接口来查询您的云主机的云硬盘
     * @return this
     */
    public CreateEcsDataDiskImageRequestBody withDataDiskID(String dataDiskID) {
     ...
     * @return this
     */
    public CreateEcsDataDiskImageRequestBody withImageName(String imageName) {
     ...
     * @return this
     */
    public CreateEcsDataDiskImageRequestBody withInstanceID(String instanceID) {
     ...
     * @return this
     */
    public CreateEcsDataDiskImageRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public CreateEcsDataDiskImageRequestBody withDescription(String description) {
     ...
     * @return this
     */
    public CreateEcsDataDiskImageRequestBody withProjectID(String projectID) {
