 ...
 * Entity: RejectSharedImageRequestBody
 */
public class RejectSharedImageRequestBody {
    /**
     * imageID
     ...
     * @return this
     */
    public RejectSharedImageRequestBody withImageID(String imageID) {
     ...
     * @return this
     */
    public RejectSharedImageRequestBody withRegionID(String regionID) {
