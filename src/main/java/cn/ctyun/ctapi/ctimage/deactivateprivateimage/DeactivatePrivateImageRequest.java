 ...
 * Request: DeactivatePrivateImageRequest
 */
public class DeactivatePrivateImageRequest extends CTRequest {
    public DeactivatePrivateImageRequest() {
        super("POST", "application/json", "/v4/image/deactivate");
    }
     ...
     * @return this
     */
    public DeactivatePrivateImageRequest withImageID(String imageID) {
     ...
     * @return this
     */
    public DeactivatePrivateImageRequest withRegionID(String regionID) {
